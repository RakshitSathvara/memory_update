package com.narmada.measure.screens.pani_bandh_yaadi.view.adapter

import android.annotation.SuppressLint
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.narmada.measure.databinding.ItemPaniBandhYaadiListBinding
import com.narmada.measure.screens.pani_bandh_yaadi.model.PaniBandhData
import java.text.SimpleDateFormat
import java.util.Locale

class PaniBandhYaadiListAdapter(
    private val dataList: MutableList<PaniBandhData>,
    private val onItemClickListener: ((PaniBandhData) -> Unit)
) :
    RecyclerView.Adapter<PaniBandhYaadiListAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: ItemPaniBandhYaadiListBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemPaniBandhYaadiListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder) {
            with(dataList[position]) {
                ...
                binding.tvVillage.text = "$villageId / $villageName"
                ...
                binding.tvMobileNo.text = phoneNumber
