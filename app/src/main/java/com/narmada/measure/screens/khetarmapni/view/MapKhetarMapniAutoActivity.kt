...
import com.narmada.measure.databinding.ActivityMapKhetarMapniAutoBinding
...
class MapKhetarMapniAutoActivity : AppCompatActivity(), View.OnClickListener {

    private val binding by lazy { ActivityMapKhetarMapniAutoBinding.inflate(layoutInflater) }
...
//        finalAreaInAcre = String.format("%.2f", areaInMeter)
    ...
    companion object {
        private const val TAG = "MapKhetarMapniAutoActivity"
    }
